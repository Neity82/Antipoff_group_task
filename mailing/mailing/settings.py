...
SECRET_KEY = 'django-insecure-abihf9fui98s0wlil(@4380!wdc=xp1!amjw1m(8)&q7ne(4(@'
...
# telegram bot
BOT_URL = env.get_value('BOT_URL')
BOT_TOKEN = env.get_value('BOT_TOKEN')
CHAT_ID = env.get_value('CHAT_ID')
API_ID = env.get_value('API_ID')
API_HASH = env.get_value('API_HASH')
...
INSTALLED_APPS = [
    ...
    'mailing_hb.apps.MailingHbConfig'
]
